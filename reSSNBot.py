...
async def slap(ctx, user: discord.Member):
    await bot.send_message(ctx.message.channel, "{} slaps {}! **KaPOW!**".format(ctx.message.author.mention, user.mention))


@bot.command(pass_context=True)
@commands.has_any_role("Daddy", "SSN Fam", "SSN")
async def punch(ctx, user: discord.Member):
    await bot.send_message(ctx.message.channel, "{} punches {}! **KaPOW!**".format(ctx.message.author.mention, user.mention))

@bot.command(pass_context=True)
@commands.has_any_role("Daddy", "SSN Fam", "SSN")
async def kiss(ctx, user: discord.Member):
    await bot.send_message(ctx.message.channel, "{} kisses {}! :heart:".format(ctx.message.author.mention, user.mention))
